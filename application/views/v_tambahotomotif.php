    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Tambah Data otomotif</h6>
                <h1 class="mb-5">PT XYZ</h1>
            </div>
            <div class="row g-4">
                        <form action="<?php echo site_url('Main_user/tambah_otomotif'); ?>" class="form-horizontal" method="post" enctype="multipart/form-data">
